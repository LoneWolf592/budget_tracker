...
-- AddForeignKey
ALTER TABLE "SharedAccess" ADD CONSTRAINT "SharedAccess_guestEmail_fkey" FOREIGN KEY ("guestEmail") REFERENCES "User"("email") ON DELETE RESTRICT ON UPDATE CASCADE;
